...
static constexpr Int_t kMaxt_ = 42;
static constexpr Int_t kMaxs = 409;
static constexpr Int_t kMaxsf = 409;
   ...
   Int_t           maxgap[42];   //[n]
   Int_t           incoming[42];   //[n]
   Float_t         impactparameter[42];   //[n]
   Int_t           MCEventID[42];   //[n]
   Int_t           MCTrackID[42];   //[n]
   Int_t           MCMotherID[42];   //[n]
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxcbmroot_Stack_MCTrack = 3104;
   static constexpr Int_t kMaxcbmroot_Box_BoxPoint = 30730;
   static constexpr Int_t kMaxcbmroot_SciFi_SciFiPoint = 288;
   static constexpr Int_t kMaxcbmroot_PixelModules_PixelModulesPoint = 3354;
   static constexpr Int_t kMaxcbmroot_MufluxSpectrometer_MufluxSpectrometerPoint = 1;
   static constexpr Int_t kMaxcbmroot_MuonTagger_MuonTaggerPoint = 1864;
   static constexpr Int_t kMaxcbmroot_Event_MCEventHeader = 1;
   static constexpr Int_t kMaxEmuBaseTrks = 30730;
