...
int TMVAClassification_MC( TString myMethodList = "" )
{
  ...
  case 1:
    ...
    signalTree = sampleTree->CopyTree("mp_motherID==0 && ntracks>4");
    backgroundTree = sampleTree->CopyTree("!(mp_motherID==0) && ntracks>4");
    break;
  case 2:
    // escludo primari
    float cut_bdt;
  ...
  case 1:
    ...
    dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
					    ...
					    "nTrain_Signal=979:nTrain_Background=633:SplitMode=Random:NormMode=NumEvents:!V" );
    break;//(1042,12156)
  case 2:
  // CUT ESCLUSI PRIMARI
    dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
  ...
  case 3:
    ...
    // CUT DS
    dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
					   "nTrain_Signal=522:nTrain_Background=5696:SplitMode=Random:NormMode=NumEvents:!V" );
    break;
  }
  ...
  if (Use["BDT"])  // Adaptive Boost
    factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT",
			 "!H:!V:NTrees=75:MinNodeSize=2.5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20" );
...
int main( int argc, char** argv )
{
  ...
  return TMVAClassification_MC(methodList);
}
