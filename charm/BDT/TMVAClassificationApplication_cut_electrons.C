...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   Float_t probability, meannseg, vtx_max_aperture, vtx_fill;
   Float_t meanIP, maxIP,varIP;
   Float_t meanTX, meanTY, fill, vx, vy, vz;
   Int_t vID, ntracks;
   reader->AddVariable("probability", &probability);
   reader->AddVariable("vtx_max_aperture", &vtx_max_aperture);
   reader->AddVariable("meanIP",&meanIP);
   reader->AddVariable("fill:=vtx_fill*ntracks",&fill);
   //reader->AddVariable("meannseg",&meannseg);
   //reader->AddVariable("ntracks",&ntracks);
   //reader->AddVariable("meanIP/(meanIP-maxIP)",&varIP);   
   //reader->AddVariable("(vtx_holes-vtx_gap)",'F');
   //reader->AddVariable("vtx_fill",'F');
  ...
  // reader->AddVariable( "var4",                &var4 );
   ...
   //
   TFile *input(0);
   TString fname = "./tmva_evaluation_fullbrick_vertices.root";
   //TString fname = "./tmva_input_MC_vertices_electron_study.root";
   ...
   theTree->SetBranchAddress("vID",&vID);
   theTree->SetBranchAddress("vx",&vx);
   theTree->SetBranchAddress("vy",&vy);
   theTree->SetBranchAddress("vz",&vz);
   theTree->SetBranchAddress("ntracks",&ntracks);
   theTree->SetBranchAddress("probability",&probability);
   theTree->SetBranchAddress("vtx_max_aperture",&vtx_max_aperture);
   theTree->SetBranchAddress("meannseg",&meannseg);
   theTree->SetBranchAddress("meanTX",&meanTX);
   theTree->SetBranchAddress("meanTY",&meanTX);
 ...
 //  theTree->SetBranchAddress( "var4", &var4 );
   ...
   TFile *fout = new TFile("vtx_BDT_fullbrick_evaluated.root","RECREATE");
