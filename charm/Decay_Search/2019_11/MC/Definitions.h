...
static constexpr Int_t kMaxt_ = 40;
static constexpr Int_t kMaxs = 765;
static constexpr Int_t kMaxsf = 765;
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxcbmroot_Stack_MCTrack = 3007;
   static constexpr Int_t kMaxcbmroot_Box_BoxPoint = 24622;
   static constexpr Int_t kMaxcbmroot_SciFi_SciFiPoint = 225;
   static constexpr Int_t kMaxcbmroot_PixelModules_PixelModulesPoint = 2290;
   static constexpr Int_t kMaxcbmroot_MufluxSpectrometer_MufluxSpectrometerPoint = 1;
   static constexpr Int_t kMaxcbmroot_MuonTagger_MuonTaggerPoint = 891;
