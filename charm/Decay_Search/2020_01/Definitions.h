...
static constexpr Int_t kMaxt_ = 79;
static constexpr Int_t kMaxs = 700;
static constexpr Int_t kMaxsf = 700;
   ...
   Int_t           maxgap[48];   //[n]
   Int_t           incoming[48];   //[n]
   Float_t         impactparameter[48];   //[n]
   Int_t           MCEventID[48];   //[n]
   Int_t           MCTrackID[48];   //[n]
   Int_t           MCMotherID[48];   //[n]
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxcbmroot_Stack_MCTrack = 16216;
   static constexpr Int_t kMaxcbmroot_Box_BoxPoint = 58645;
   static constexpr Int_t kMaxcbmroot_SciFi_SciFiPoint = 315;
   static constexpr Int_t kMaxcbmroot_PixelModules_PixelModulesPoint = 4257;
   static constexpr Int_t kMaxcbmroot_MufluxSpectrometer_MufluxSpectrometerPoint = 1;
   static constexpr Int_t kMaxcbmroot_MuonTagger_MuonTaggerPoint = 1585;
   static constexpr Int_t kMaxcbmroot_Event_MCEventHeader = 1;
   static constexpr Int_t kMaxEmuBaseTrks = 58645;
